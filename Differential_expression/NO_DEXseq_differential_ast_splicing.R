...
setwd("~/Dropbox/Edinburgh/Projects/Asian_psyllid/Gene_Expression/Counts")
...
setwd("~/Dropbox/Edinburgh/Projects/Asian_psyllid/Gene_Expression/Diff_alt_splicing")
...
aSwitchList <- importRdata(
  ...
  isoformExonAnnoation = "Dcitr_OGSv3_beta_dexseq2.gtf",
  showProgress = TRUE)
