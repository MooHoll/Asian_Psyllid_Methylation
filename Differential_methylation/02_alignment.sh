...
rsync /data/ross/misc/analyses/asian_psyllid/genome/lambda2.fa ./lambda
...
do
	...
	bismark --dovetail --multicore 8 -o ./alignment_Dcitri \
...
do
	base=$(basename ${file} "1.clean.fq.gz")
	bismark --dovetail --multicore 8 -o ./alignment_lambda \
